...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MPLY,            KC_GUITB, KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
                 KC_GAME, KC_LCTL, KC_LALT, KC_LOWER, CTL_T(KC_ENT),      ALT_T(KC_SPC),  KC_RAISE, KC_RALT, LCTL_T(KC_APP), KC_RGUI
),
...
[_GAME] = LAYOUT(
  ...
  KC_TAB,   KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                             KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN,  KC_QUOT,
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MPLY,           KC_GUITB,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
                 KC_GAME,KC_LALT,KC_LCTL, KC_SPC, KC_ENT,      KC_SPC,  KC_RAISE, KC_RCTL, KC_RALT, KC_RGUI
),
